...
<head>
    <meta charset="UTF-8">
    <title>Create a new beer journal</title>
...
<body>
    ...
    <div class="detail-container">
        <form id="createBeerForm" data-bind="submit: submitForm" class="detail-left">
    ...
    <div class="detail-actions">
        ...
        <button type="submit" form="createBeerForm">Save</button>
    </div>
