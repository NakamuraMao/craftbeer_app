<form id="createBeerForm" data-bind="submit: submitForm">
    ...
    <label for="ABV">ABV (Alcohol By Volume):</label>
    <input type="number" id="ABV" data-bind="value: ABV" step="0.1">

    <label for="origin">Origin:</label>
    <input type="text" id="origin" data-bind="value: origin">

    <label for="sampled_date">Sampling Date:</label>
    <!-- Date input for selecting only the date -->
    <input type="date" id="sampled_date" data-bind="value: sampled_dateFormatted" required>
...
<script src="/assets/js/createBeer.js"></script>